...
import com.example.zipfront.databinding.ActivityModify3Binding
import com.example.zipfront.databinding.MatchingOptionBinding


class ModifyActivity3: AppCompatActivity() {
    lateinit var binding: ActivityModify3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityModify3Binding.inflate(layoutInflater)
