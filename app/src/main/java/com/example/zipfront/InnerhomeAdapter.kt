...
class InnerhomeAdapter(private val itemList: List<RetrofitClient2.HomeItemResponse>) : RecyclerView.Adapter<InnerhomeAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: RetrofitClient2.HomeItemResponse) {
