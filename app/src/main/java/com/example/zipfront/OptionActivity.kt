...
import com.example.zipfront.databinding.ActivityOptionBinding
...
class OptionActivity: AppCompatActivity() {
    ...
    var request : RetrofitClient2.RequestLocationFilter? = null
    ...
    private val managementOptionList: MutableList<RetrofitClient2.ManagementOption> =
        mutableListOf()
    private val internalFacilityList: MutableList<RetrofitClient2.InternalFacility> =
        mutableListOf()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.imageButton7.setOnClickListener {
            if (isChoose) {
                ...
                request = RetrofitClient2.RequestLocationFilter(
...
//        }
        ...
        for (i in 0 until 48) {
            ...
            button.setOnClickListener {
                ...
                if (checkArray.any { it }) {
                    binding.imageButton7.setImageResource(R.drawable.btn__apply_active1)
                    isChoose = true
                } else {
                    binding.imageButton7.setImageResource(R.drawable.btn__apply_disabled1)
                    isChoose = false
                }
            }
        }
    ...
    fun sendData() : RetrofitClient2.RequestLocationFilter{
        return RetrofitClient2.RequestLocationFilter(
            roomType = roomTypeList,
            dealTypes = dealTypesList,
            dealInfoMap = dealInfoMap,
            roomSize = roomSizeList,
