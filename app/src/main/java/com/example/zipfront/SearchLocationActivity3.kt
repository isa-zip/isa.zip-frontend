...
class SearchLocationActivity3 :AppCompatActivity(), ItemClickHandler2, OnItemClick {
    ...
    private lateinit var locationAdapter: LocationAdapter3
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.searchEt.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                if (binding.searchEt.length() == 0) {
                    ...
                    val currentSearchAdapter = CurrentSearchAdapter(this@SearchLocationActivity3, searchLocationList)
                    handler.post {
                        // UI 업데이트 코드
        ...
        binding.currentSearchLv.onItemClickListener =
            AdapterView.OnItemClickListener { parent, view, position, id ->
                ...
                //아이템 클릭시 지도 화면으로 넘어감
                val intent = Intent(this, SearchMapActivity3::class.java)
    ...
    private fun initRecyclerView() {
        ...
        locationAdapter = LocationAdapter3(mutableListOf(), this)
